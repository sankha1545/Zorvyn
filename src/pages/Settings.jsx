...
import { User, Bell, Palette, Shield, Edit2 } from 'lucide-react';
  ...
  return (
    <div className="w-full h-full overflow-y-auto">
      <div className="p-4 sm:p-6 lg:p-8 space-y-6">
        {/* Header */}
        <div>
          <h2 className="text-2xl sm:text-3xl font-bold" style={{ color: 'var(--text-primary)' }}>Settings</h2>
            ...
            <Card.Header className="flex flex-row gap-3 px-5 pt-5 pb-0 justify-between items-start">
              ...
              {role === 'admin' && (
                <button
                  ...
                  className="p-2 rounded-lg hover:bg-opacity-10 transition-colors flex items-center gap-2 text-sm font-medium shrink-0"
                  style={{
