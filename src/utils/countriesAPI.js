/**
 * Countries and States API utility
 * Uses restcountries.com and countriesnow.space APIs for fetching country and state data
 */

// Comprehensive countries list with dial codes
const countriesData = [
